...
```
git clone git@github.com:$USER/ux-primitives.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `ux-primitives` repository on GitHub to your computer.
